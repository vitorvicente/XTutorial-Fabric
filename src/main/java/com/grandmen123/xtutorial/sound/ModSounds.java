...
public class ModSounds {
    ...
    public static final BlockSoundGroup ANIMATED_BLOCK_SOUNDS =
            new BlockSoundGroup(1f, 1f, ModSounds.ANIMATED_BLOCK_BREAK, ModSounds.ANIMATED_BLOCK_WALK,
                                ModSounds.ANIMATED_BLOCK_PLACE, ModSounds.ANIMATED_BLOCK_HIT,
                                ModSounds.ANIMATED_BLOCK_WALK);

    public static SoundEvent MUSIC_BOX = registerSoundEvent("music_box");

    private static SoundEvent registerSoundEvent(String name) {
        Identifier id = new Identifier(XTutorial.MOD_ID, name);
